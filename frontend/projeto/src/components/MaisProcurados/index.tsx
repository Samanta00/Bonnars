...
export default function MaisProcurados() {
  return (
    <>
      <h2 className="container text-center my-3">Produtos que estão bombando</h2>
      <div className="container row mx-auto">

        <div className="col-12 col-md-6 col-xxl4 pb-4">
          <div className="card">
            ...
            <div className="card-body">
              ...
              <p>R$30,00</p>
              <a href="#" className="btn btn-primary botao-lilas rounded-0 border-0">Ver mais</a>
            </div>
          </div>
        </div>
